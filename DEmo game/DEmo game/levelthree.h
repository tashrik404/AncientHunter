...
void tileShower3(){
	iShowImage(0,0,resWidth,resHeight,bgAnimShower[bgindex]);
	...
	iShowImage(0+dx,0+dy,50,50,level2ImageShower[0]);
		...
		iShowImage(400,0,50,50,level2ImageShower[0]);
		iShowImage(450,0,50,50, level2ImageShower[0]);
		iShowImage(500,0,50,50,level2ImageShower[0]);
		...
		iShowImage(850,0,50,50,level2ImageShower[0]);
		iShowImage(900,0,50,50,level2ImageShower[0]);
		iShowImage(950,0,50,50,level2ImageShower[0]);
		iShowImage(1000,0,50,50,level2ImageShower[0]);
		...
		iShowImage(350,50,50,50,level2ImageShower[1]);

		iShowImage(400,50,50,50,level2ImageShower[1]);
		iShowImage(450,50,50,50, level2ImageShower[1]);
		iShowImage(500,50,50,50,level2ImageShower[1]);
